...
public class JSONReactorResponseRendererTest extends AbstractUnitTest {
    ...
    private static final String HEADER_LINE_1 = "headerLine1";
    ...
    public void shouldHaveAllEntriesInOutputJSON() {
        ...
        // when render lines
        jsonRenderer.renderHeadLine(HEADER_LINE_1, HEADER_TEMPLATE, HEADER_PARAM_1, HEADER_PARAM_2);
        ...
        // then
        assertThat(jsonObject.getString(HEADER_LINE_1)).isEqualTo(
